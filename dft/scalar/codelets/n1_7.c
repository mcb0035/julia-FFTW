...
/* Generated by: ../../../genfft/gen_notw.native -fma -reorder-insns -schedule-for-pipeline -compact -variables 4 -standalone -pipeline-latency 4 -n 7 -name n1_7 -include n.h */
...
void n1_7(const R *ri, const R *ii, R *ro, R *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
/* Generated by: ../../../genfft/gen_notw.native -compact -variables 4 -standalone -pipeline-latency 4 -n 7 -name n1_7 -include n.h */
