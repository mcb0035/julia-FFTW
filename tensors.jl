...
function tensor_tornk1(t::Ptr{tensor}, n::Ptr{INT}, is::Ptr{INT}, os::Ptr{INT})::Cint
...
function tensor_inplace_strides(sz::Ptr{tensor})::Cint
...
function tensor_inplace_strides2(a::Ptr{tensor}, b::Ptr{tensor})::Cint
    return Cint(Bool(tensor_inplace_strides(a)) && Bool(tensor_inplace_strides(b)))
end

#int X(tensor_strides_decrease) in kernel/tensor4.c:98
function tensor_strides_decrease(sz::Ptr{tensor}, vecsz::Ptr{tensor}, k::inplace_kind)::Cint
...
function tensor_equal(a::Ptr{tensor}, b::Ptr{tensor})::Cint
...
function tensor_inplace_locations(sz::Ptr{tensor}, vecsz::Ptr{tensor})::Cint
